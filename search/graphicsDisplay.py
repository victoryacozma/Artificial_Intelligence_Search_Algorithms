...
# Food
FOOD_COLOR = formatColor(1,0.1,1)
FOOD_SIZE = 0.1

#HERE
#PORTAL
PORTAL_COLOR = formatColor(1,0,0)
PORTAL_SIZE = 0.5
...
class InfoPane:
    ...
    def drawPane(self):
        self.scoreText = text( self.toScreen(0, 0  ), self.textColor, "Punctaj:    0", "Times", self.fontSize, "bold")
...
class PacmanGraphics:
    ...
    def drawStaticObjects(self, state):
        ...
        self.portal=self.drawportal(layout.portal)
    ...
    def drawAgentObjects(self, state):
        ...
        refresh()
        # Here
    def drawportal(self,squareMatrix):
        squareImages = []
        color = PORTAL_COLOR
        for xNum, x in enumerate(squareMatrix):
            if self.capture and (xNum * 2) <= squareMatrix.width: color = TEAM_COLORS[0]
            if self.capture and (xNum * 2) > squareMatrix.width: color = TEAM_COLORS[1]
            imageRow = []
            squareImages.append(imageRow)
